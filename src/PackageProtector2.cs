...
namespace Neliva.Security.Cryptography
{
    ...
    /// </summary>
    public sealed class PackageProtector2 : IDisposable
    {
        ...
        public PackageProtector2(int ivSize, int packageSize, RngFillAction rngFill = null)
        {
            switch (ivSize)
            {
                case 0:
            ...
            const int KdfMaxPackageSize = (16 * 1024 * 1024) - BlockSize; // KDF has a limit
